...
@section('content')
    <div class="col-md-12">
        <form name="register-form" action="/mobiles/delete?id={{$item->id}}" method="post">
            @csrf
            <section class="panel">
                ...
                <footer class="panel-footer">
                    <button type="submit" class="btn btn-danger pull-right">CONFIRM DELETE THIS PRODUCT</button>
                </footer>
            </section>
        </form>
    </div>
